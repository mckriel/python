...
start_button = Button(text='Start', highlightthickness=0, bg=YELLOW, font=(FONT_NAME, 12), command=start_timer)
start_button.grid(column=0, row=2)

reset_button = Button(text='Reset', highlightthickness=0, bg=YELLOW, font=(FONT_NAME, 12), command=reset_timer)
